...
namespace WebHocTiengAnh.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public AnswersController(DBcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ExerciseId,AnswerText")] Answer answer)
        {
            ...
            ViewData["ExerciseId"] = new SelectList(_context.Exercises, "Id", "Id", answer.ExerciseId);
            return View(answer);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ExerciseId,AnswerText")] Answer answer)
        {
            if (id != answer.Id)
            {
                return NotFound();
